...
use BlogBundle\Entity\Repository\TaxonomyRepository;
...
class ArticleEventListener implements EventSubscriberInterface
{
    ...
    function __construct(Registry $doctrine, Session $session, TaxonomyRepository $taxonomyRepository)
    {
    ...
    public function postSave(ArticleAdministrationEvent $event)
    {
        ...
        if($article)
        {
            ...
            $categories = $this->taxonomyRepository->getArticleTaxonomyCount($taxonomies);
