...
use BlogBundle\Forms\MediaInfoType;
use BlogBundle\Forms\ArticlePhotoType;
use BlogBundle\Forms\MediaType;
...
class MediaController extends DefaultController
{
    ...
    private function getPaginated($paginator, $paramsForTwig = array(), $ajaxParams = array())
    {
        ...
        $response = $paginator->paginate(
            $queryBuilder,
            'BlogBundle:Media:list',
            'BlogBundle:Global:paginationClassic',
            $paramsForTwig,
            Pagination::DOZEN,
            null,
    ...
    public function uploadExcerptAction(Request $request)
    {
        ...
        if ($request->getMethod() == 'POST')
        {
            ...
            return new JsonResponse(array('success' => 'true', 'id' => $media->getId(), 'href' => $this->generateUrl('ed_blog_admin_media_delete', array(
                'id' => $media->getId())),
                'media' => $this->renderView('BlogBundle:Media:image.html.twig', array('media' => $media))));
        }
    ...
    public function editInfoAction(Request $request, Media $media)
    {
        ...
        return $this->render("BlogBundle:Media:editInfoForm.html.twig", array(
            "id" => $media->getId(),
    ...
    public function editAction(Request $request, $media)
    {
        ...
        if($request->isXmlHttpRequest())
        {
            return new JsonResponse(array(
                "success" => true,
                "html" => $this->renderView('@Blog/Media/editForm.html.twig', array(
                    'media' => $media,
                    'form' => $form->createView()
                ))
            ));
        ...
        {
            return $this->render("@Blog/Media/edit.html.twig", array(
                'media' => $media,
                'form' => $form->createView()
            ));
        }
    ...
    public function cropAction(Request $request, $media)
    {
        ...
        return new JsonResponse( array(
            'success' => true,
            'html' => $this->renderView('@Blog/Media/cropPanel.html.twig', array(
                'media' => $mediaNew
            )),
