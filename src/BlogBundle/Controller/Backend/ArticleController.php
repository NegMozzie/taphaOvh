...
class ArticleController extends DefaultController
{
    ...
    public function editAction(Request $request, $article)
    {
        ...
        //get writing lock
        $isWritingLocked = $this->get('blog.handler.article_handler')->isLocked($user, $article);
    ...
    private function getPaginated($paginator, $ajaxParams = array(), $folder='Media')
    {
        ...
        $response = $paginator->paginate(
            $queryBuilder,
            'BlogBundle:Article/' . $folder. ':list',
            'BlogBundle:Global:pagination',
            array(),
            Pagination::DOZEN,
            null,
            'BlogBundle:Global:pagination.html.twig',
            $ajaxParams,
    ...
    public function showAction(Request $request, Article $article)
    {
        ...
        return $this->render("BlogBundle:Article:show.html.twig",
            array(
                'article' => $article,
                'form' => $form->createView(),
                'comments' => $comments
    ...
    public function checkWritingLockAction(Request $request, $article)
    {
        ...
        else
        {
            ...
            return new JsonResponse(array(
                'success' => true,
                'lock' => true,
                'html' =>  $this->renderView('@Blog/Article/checkWritingLock.html.twig', array(
                    'user' => $userLocked
                ))
            ));
        }
    ...
    public function takeoverAction($article)
    {
        ...
        $this->get('blog.handler.article_handler')->takeoverLock($user, $article);
