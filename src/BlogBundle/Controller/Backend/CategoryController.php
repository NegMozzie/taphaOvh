...
class CategoryController extends DefaultController
{
    ...
    public function listAction(Request $request)
    {
        ...
        $response = $paginator->paginate(
            ...
            'BlogBundle:Taxonomy/Category:list' . (($orderBy ) ? '_sortable' : '')  ,
            'BlogBundle:Taxonomy:pagination',
            array(
                'orderBy' => $orderBy,
                'order' => $order
            ),
            Pagination::DOZEN,
            null,
            $paginationTemplate = 'BlogBundle:Taxonomy:pagination.html.twig',
            array(),
            null
        );
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render("@Blog/Taxonomy/Category/create.html.twig", array(
    ...
    public function editAction(Request $request, $slug)
    {
        ...
        return $this->render("@Blog/Taxonomy/Category/edit.html.twig", array(
            'form' => $form->createView(),
            'slug' => $slug
        ));
    }
    ...
    public function allPrettyAction(Request $request, $template)
    {
        ...
        return new JsonResponse(array(
            'success' => true,
            'html' => $this->renderView("@Blog/Taxonomy/Category/pretty" . ($template == 'all' ? "" : "_$template") . ".html.twig", array(
