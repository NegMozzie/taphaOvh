...
class TagController extends DefaultController
{
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render("@Blog/Taxonomy/Tag/create.html.twig", array(
    ...
    public function editAction(Request $request, $slug)
    {
        ...
        return $this->render("@Blog/Taxonomy/Tag/edit.html.twig", array(
            'form' => $form->createView(),
            'slug' => $slug
        ));
    }
    ...
    public function topTagsAction($number)
    {
          ...
          return $this->render("BlogBundle:Frontend/Blog:blog_sidebar_tags.html.twig", array('topNtags' => $topNtags));
    }
}