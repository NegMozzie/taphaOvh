...
use Msports\EventBundle\Model\Event;
 ...
 * @ORM\Entity(repositoryClass="Msports\EventBundle\Entity\Repository\ChampionshipRepository")
 */
class Championship extends Event
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Msports\EventBundle\Entity\Season", inversedBy="events")
    ...
    /**
     * @ORM\OneToMany(targetEntity="Msports\EventBundle\Entity\GrandPrix", mappedBy="parent")
     */
    protected $children;

    /**
     * @ORM\OneToMany(targetEntity="Msports\EventBundle\Entity\Classement", mappedBy="champ", cascade={"persist", "remove"})
     */
    protected $classements;

    /**
     * @ORM\ManyToMany(targetEntity="Msports\EventBundle\Entity\Team", inversedBy="events")
    ...
    protected $teams;
     ...
     /**
     * @ORM\ManyToOne(targetEntity="Msports\BlogBundle\Entity\Category", inversedBy="events")
     * @ORM\JoinColumn(name="category_id", referencedColumnName="id", onDelete="SET NULL", nullable=true)
     */
    protected $category;

    /**
     * @ORM\ManyToMany(targetEntity="Msports\EventBundle\Entity\Comment")
