 ...
 * @ORM\Entity(repositoryClass="Msports\EventBundle\Entity\Repository\PilotRepository")
 */
class Pilot extends BaseUser
{
    ...
    protected $excerptPhoto;
     /**
     * @ORM\ManyToOne(targetEntity="Msports\EventBundle\Entity\Team", inversedBy="pilots")
