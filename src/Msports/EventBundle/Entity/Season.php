 ...
 * @ORM\Entity(repositoryClass="Msports\EventBundle\Entity\Repository\SeasonRepository")
 */
class Season
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Msports\EventBundle\Entity\Championship", mappedBy="parent")
     */
    protected $events;
