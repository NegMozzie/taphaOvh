 ...
 * @ORM\Entity(repositoryClass="Msports\EventBundle\Entity\Repository\CourseRepository")
 */
class Course extends Event
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="Msports\BlogBundle\Entity\Article")
     * @ORM\JoinColumn(name="article_id", referencedColumnName="id", nullable=true)
     */
    protected $article;

    /**
     * @ORM\ManyToOne(targetEntity="Msports\EventBundle\Entity\GrandPrix", inversedBy="children")
    ...
    /**
     * @ORM\OneToMany(targetEntity="Msports\EventBundle\Entity\Classement", mappedBy="course", cascade={"persist", "remove"})
     */
