...
/**
 * @ORM\Table(name="team")
 * @ORM\Entity(repositoryClass="Msports\EventBundle\Entity\Repository\TeamRepository")
 */
...
class Team
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Msports\EventBundle\Entity\Pilot", mappedBy="team")
     */
    protected $pilots;
    
    /**
     * @ORM\ManyToMany(targetEntity="Msports\EventBundle\Entity\Championship",mappedBy="teams")
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Msports\BlogBundle\Entity\Category", inversedBy="teams")
