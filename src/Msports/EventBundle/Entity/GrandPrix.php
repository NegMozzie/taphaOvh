 ...
 * @ORM\Entity(repositoryClass="Msports\EventBundle\Entity\Repository\GrandPrixRepository")
 */
class GrandPrix extends Event
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Msports\EventBundle\Entity\Championship", inversedBy="children")
    ...
    /**
     * @ORM\OneToMany(targetEntity="Msports\EventBundle\Entity\Course", mappedBy="parent")
     */
    protected $children;
