...
{
    public function getSortableQuery($orderBy, $order, $type = Category::TYPE_CATEGORY)
    {
    ...
    public function getAllCategories()
    {
        ...
        $results = $this->getEntityManager()
            ->createQuery($query)
            ->setParameter("category", Category::TYPE_CATEGORY);
    ...
    public function getArticleTaxonomyCount($categoryIds = array())
    {
        $taxonomyClass = $this->_entityName;
    ...
    public function getArticleTagCount($tagIds = array())
    {
        ...
        $query = $this->getEntityManager()
            ->createQuery($query)
            ->setParameter("published", Article::STATUS_PUBLISHED)
            ->setParameter('tag', Category::TYPE_TAG)
            ->setParameter('cur', new \DateTime());
    ...
    public function getTagByTitles($tagTitles)
    {
        ...
        $results = $this->getEntityManager()
            ...
            ->setParameter('tagType', Category::TYPE_TAG);
    ...
    public function updateTaxonomyCount(Taxonomy $taxonomy, $count)
    {
        $taxonomyClass = $this->_entityName;
