...
use ED\BlogBundle\Controller\Frontend\BlogController as Controller;
...
class BlogController extends Controller
{
    ...
    {
        $taxonomyType = Category::TYPE_TAG;
    ...
    public function byAuthorbarAction($user = null)
    {
        ...
        return $this->render("MsportsBlogBundle:Frontend/Blog:blog_articlebar.html.twig", array(
    ...
    public function byCategorytagAction($categorySlug)
    {
        ...
        return $this->render("EDBlogBundle:Frontend/Blog:blog_navbar_article.html.twig", array(
                'paginator' => $paginator,
                ));
    }
